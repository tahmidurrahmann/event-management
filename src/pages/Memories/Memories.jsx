    ...
    return (
        <div className="my-4 md:my-10">
            ...
            <div className='grid grid-cols-1 lg:grid-cols-3 gap-6 text-center my-16 p-8'>
                <div className='bg-gray-100 p-20 rounded-lg space-y-4' data-aos="zoom-in" data-aos-duration="2000">
                    <div className='bg-white p-3 rounded-full w-[40px] mx-auto'>
                        <FaUserAstronaut></FaUserAstronaut>
                    </div>
                    <h1 className='text-xl text-[#F9A51A] font-semibold'>Free Consultations</h1>
                ...
                <div className='bg-white p-3 rounded-full w-[40px] mx-auto'>
                    ...
                    <h1 className='text-xl text-[#F9A51A] font-semibold'>Certified Expert</h1>
                ...
                <div className='bg-white p-3 rounded-full w-[40px] mx-auto'>
                    ...
                    <h1 className='text-xl text-[#F9A51A] font-semibold'>Premium material</h1>
