        ...
        <div>
            <div className="background h-[250px] md:h-[400px] lg:h-[550px] p-10" data-aos="zoom-out-down" data-aos-duration="2000">
                ...
                <div className='flex justify-center'>
                    <h1 className='text-[#F9A51A] text-4xl md:text-7xl font-bold'>CONTACT US</h1>
                </div>
            </div>
            <div className='grid grid-cols-1 lg:grid-cols-3 gap-6 text-center my-16 p-8 container mx-auto'>
                <div className='bg-[#ABCE4E] p-20 rounded-lg space-y-4' data-aos="zoom-in" data-aos-duration="2000">
                ...
                <div className='bg-[#F55D52] p-20 rounded-lg space-y-4' data-aos="zoom-in" data-aos-duration="2000">
                    <div className='bg-white p-3 rounded-full w-[40px] mx-auto'>
                ...
                <div className='bg-[#5B9ACF] p-20 rounded-lg space-y-4' data-aos="zoom-in" data-aos-duration="2000">
                    <div className='bg-white p-3 rounded-full w-[40px] mx-auto'>
