const Banner = () => {
    return (
            <div className="flex flex-col md:my-10 lg:my-24 md:flex-row p-16 md:p-8 lg:p-0 gap-10 md:gap-20 justify-center items-center" data-aos="fade-down" data-aos-duration="3000">
