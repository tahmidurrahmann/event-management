const Banner = () => {
    return (
            <div className="flex flex-col md:my-10 lg:my-24 md:flex-row p-16 md:p-8 lg:p-0 gap-10 md:gap-20 justify-center items-center">
                <div className="space-y-5" data-aos="fade-down" data-aos-duration="3000">
                ...
                <img className="w-full md:w-[50%] lg:w-[40%]" src="https://i.ibb.co/fNBYP8Y/customer-service.png" alt="" data-aos="fade-up" data-aos-duration="3000"/>
            </div>
    );
};
