const Banner = () => {
    return (
        <div className="md:my-10 lg:my-24 flex flex-col md:flex-row p-16 md:p-8 lg:p-0 gap-10 md:gap-20 justify-center items-center">
            <div className="space-y-5">
                ...
                <button className="py-3 px-7 rounded-lg text-white font-medium bg-[#F9A51A]">WHAT WE OFFER</button>
            </div>
            <img className="w-[90%] md:w-[50%] lg:w-[40%]" src="https://i.ibb.co/fNBYP8Y/customer-service.png" alt="" />
        </div>
    );
};
